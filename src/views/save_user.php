  ...
  <form action="#" method="POST">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input value="<?= $name ?>" type="text" id="name" name="name" placeholder="Informe o nome"
      ...
      <div class="form-group col-md-6">
        ...
        <input value="<?= $email ?>" type="email" id="email" name="email" placeholder="Informe o email"
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="start_date">Data de Adminssão</label>
        <input value="<?= $start_date ?>" type="date" id="start_date" name="start_date"
      ...
      <div class="form-group col-md-6">
        ...
        <input value="<?= $end_date ?>" type="date" id="end_date" name="end_date"
